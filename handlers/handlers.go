...
func HomeHandler(w http.ResponseWriter, r *http.Request) {
        ...
        contents, err := db.GetRidership(selectedChart)
        if err != nil {
                fmt.Printf("Could not get contents\n")
        }
        // TODO: some code goes here
        ...
        barChartBytes, err := utils.GenerateBarChart(contents)
        if err != nil {
                fmt.Printf("err generating bar chart bytes\n")
        }
        barChartStr := base64.StdEncoding.EncodeToString(barChartBytes)
        ...
        data := struct {
                ...
                Image: barChartStr, // TODO: base64 string
                Chart: selectedChart,
        }
        ...
        if err != nil {
                fmt.Printf("err executing template\n")
        }
}
